    ...
    <footer>
      <div className="max-w-screen-xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
        ...
        <div className="mt-8 flex justify-center items-center">
          <a
            href="https://twitter.com/jonbellah"
          ...
          <a
            href="https://github.com/jonbellah"
            className="ml-6 text-gray-400 hover:text-gray-500"
          >
          ...
          <a
            href="https://instagram.com/jonbellah"
            className="ml-6 text-gray-400 hover:text-gray-500"
          >
          ...
          <a href="/rss.xml" className="ml-6 text-gray-400 hover:text-gray-500">
        ...
        <div className="mt-8">
          <p className="text-center text-base leading-6 text-gray-400">
            &copy; 2020 Jon Bellah. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
